...
8. Arrow func
*/
function GetUser() { } // this is name func we have to add type after writing function name and if the function is not returning anything then we have to  provide Void Type After writing the name of that function
// function():void {}/*  this is anonymous function */
const newFunc = () => { }; // this is arrow func
//** optional parameters *********?*********
...
function GetNewUser(name, age, gender) { }
GetNewUser("Mollik", 21);
// rest functions
function GetListOfName(...names) { } // it means we can provide as much of data as we want and all of those data should be set into a Array and we have also set the type of that array. it is similar to spread operator
